...
HD_PWD='C:/Users/iamaa/OneDrive/Documents/ArtyA7Projects/BinaryCalcBasys3/BinaryCalcBasys3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BinaryCalc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BinaryCalc.tcl -notrace
