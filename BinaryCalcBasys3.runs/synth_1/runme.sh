...
HD_PWD='C:/Users/iamaa/OneDrive/Documents/ArtyA7Projects/BinaryCalcBasys3/BinaryCalcBasys3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BinaryCalc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BinaryCalc.tcl
